...
describe("Plugin Parser", () => {
    test("can find pattern", () => {
        [
            ...
            {s: "xxx [[test]] [[test]]", v: [{match: "[[test]]", arguments: []}, {match: "[[test]]", arguments: []}]},
            {
                s: "xxx [[test]] [[test]] xxx",
                v: [{match: "[[test]]", arguments: []}, {match: "[[test]]", arguments: []}],
            },
            ...
            {s: "[[test]][[test]]", v: [{match: "[[test]]", arguments: []}, {match: "[[test]]", arguments: []}]},
